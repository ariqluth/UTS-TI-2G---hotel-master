        ...
        <li>{{ $error }}</li>
         ...
         <form method="post" action="{{ route('kamar.store') }}" id="myForm">
            ...
            <div class="form-group">
                ...
                <input type="no_kamar" name="no_kamar" class="form-control" id="no_kamar" aria-describedby="no_kamar" >
            </div>
            ...
            <div class="form-group">
                ...
                <input type="fasilitas" name="fasilitas" class="form-control" id="fasilitas" ariadescribedby="fasilitas" >
            </div>
